...
async def roll(ctx: discord.Interaction, diceroll: str = "d20", reason: str = None):
...
async def advantage(ctx: discord.Interaction, diceroll: str = "d20", reason: str = None):
...
async def disadvantage(ctx: discord.Interaction, diceroll: str = "d20", reason: str = None):

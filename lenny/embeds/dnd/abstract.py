...
def build_list(entry: DNDEntry, value: str | DescriptionListList, char_field_limit: int = 1024) -> str:
    ...
    if len(joined) > char_field_limit:
        return f"The list for [{entry.name} can be found here]({entry.url})."
    return joined
    ...
    def add_description_fields(
        ...
        for description in descriptions:
            ...
            if description["type"] == "text":
                ...
                value = build_list(self._entry, description["list"], char_field_limit)
            else:
                value = ""

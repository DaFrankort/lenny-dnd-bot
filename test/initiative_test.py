...
class TestInitiativeTracker:
    ...
    def test_swap(self, tracker):
        ...
        initiative_1, initiative_2 = Initiative(itr, 0, name_1), Initiative(itr, 0, name_2)
        ...
        assert [(i.name, i.get_total()) for i in initiatives] == [(name_1, high), (name_2, low)]

        tracker.swap(itr, name_1, name_2)

        initiatives = tracker.get(itr)
        assert [(i.name, i.get_total()) for i in initiatives] == [(name_2, high), (name_1, low)]

...
class TestSearch:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (Data.spells.all_entries[0], spell_name_autocomplete),
            (Data.items.all_entries[0], item_name_autocomplete),
            (Data.conditions.all_entries[0], condition_name_autocomplete),
            (Data.creatures.all_entries[0], creature_name_autocomplete),
            (Data.classes.all_entries[0], class_name_autocomplete),
            (Data.rules.all_entries[0], rule_name_autocomplete),
            (Data.actions.all_entries[0], action_name_autocomplete),
            (Data.feats.all_entries[0], feat_name_autocomplete),
            (Data.languages.all_entries[0], language_name_autocomplete),
            (Data.backgrounds.all_entries[0], background_name_autocomplete),
            (Data.tables.all_entries[0], table_name_autocomplete),
            (Data.species.all_entries[0], species_name_autocomplete),
            (Data.vehicles.all_entries[0], vehicle_name_autocomplete),
            (Data.objects.all_entries[0], object_name_autocomplete),
            (Data.hazards.all_entries[0], hazard_name_autocomplete),
            (Data.cults.all_entries[0], cult_name_autocomplete),
            (Data.boons.all_entries[0], boon_name_autocomplete),
        ],
    )

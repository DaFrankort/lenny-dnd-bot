    ...
    Roll = HelpTab(
        ...
        info=[
            ...
            (
                "Reasons",
                [
                    "You can provide reasons to your dice rolls to make distinguishing results easier. Some specific reasons also have their own sound effects, namely:",
                    "- *Heal*",
                    "- *Fire*",
                    "- *Attack*",
                    "- *Damage*",
        ...
        info=[
            ...
            (
                ...
                [
                    ...
                    "- If the value of a piece isn't specified in a subtraction or addition, it default to **GP**. (e.g. ``1gp - 1 = 0gp``)",
                    "- Results of calculations will only use the coin units specified in the original expression, you can finetune the result by pressing the unit-buttons in the response message.",
                ],
            ),
        ],
    )
